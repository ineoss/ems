...
const weexEntry = {
  ...
  'AddUser': helper.root('entry/AddUser.js'),
  'AddEquip': helper.root('entry/AddEquip.js'),
  'InStock': helper.root('entry/InStock.js'),
  'OutStock': helper.root('entry/OutStock.js'),
  'StockList': helper.root('entry/StockList.js'),
  'UserList': helper.root('entry/UserList.js'),
  'EquipList': helper.root('entry/EquipList.js'),
  'EquipDetail': helper.root('entry/EquipDetail.js'),
  'UserDetail': helper.root('entry/UserDetail.js'),
  'ModifyUser': helper.root('entry/ModifyUser.js'),
  'ModifyEquip': helper.root('entry/ModifyEquip.js'),
  'AddBuyPlan': helper.root('entry/AddBuyPlan.js'),
  'BuyPlanList': helper.root('entry/BuyPlanList.js'),
  'BuyPlanDetail': helper.root('entry/BuyPlanDetail.js'),
  'ModifyBuyPlan': helper.root('entry/ModifyBuyPlan.js'),
  'EndBuyPlan': helper.root('entry/EndBuyPlan.js'),
  'BuyHistory': helper.root('entry/BuyHistory.js'),
  'BuyHistoryDetail': helper.root('entry/BuyHistoryDetail.js'),
  'CanBorrowList': helper.root('entry/CanBorrowList.js'),
  'BorrowAuditingList': helper.root('entry/BorrowAuditingList.js'),
  'BorrowDetail': helper.root('entry/BorrowDetail.js'),
  'BorrowedList': helper.root('entry/BorrowedList.js'),
  'BorrowedDetail': helper.root('entry/BorrowedDetail.js'),
  'AddGiveup': helper.root('entry/AddGiveup.js'),
  'GiveupList': helper.root('entry/GiveupList.js'),
  'GiveupDetail': helper.root('entry/GiveupDetail.js'),
  'AddRepaire': helper.root('entry/AddRepaire.js'),
  'MyBorrowApply': helper.root('entry/MyBorrowApply.js'),
  'NeedOverhaul': helper.root('entry/NeedOverhaul.js'),
  'RepaireHistory': helper.root('entry/RepaireHistory.js'),
  'RepaireDetail': helper.root('entry/RepaireDetail.js'),
}

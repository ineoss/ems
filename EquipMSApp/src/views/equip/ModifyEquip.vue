<template>
<div class="modifyequip-wrapper">
	<mini-bar title="修改设备信息" back="true"></mini-bar>
  <div class="main">
    <div class="row">
			<text class="label" >资产编号：</text>
			<text class="input" style="line-height:80px;">{{equip.assetNo}}</text>
...
export default {
  ...
  methods: {
    submit() {
      ...
      if (this.checkFormValue(this.equip.assetNo, '资产编号不能为空')
        && this.checkFormValue(this.equip.name, '请输入设备名')
